	...
	var MyShowcaseAccount = {
	    ...
	    editBodyText: (function(artefactId){
			...
			bodyText = bodyText.replace("</p>", "");
			var editBodyText = '<p><input id="edit-bodytext-' + artefactId + '" type="textarea" value="' + bodyText + '"/></p>' ;
...
//					    	$('#ms-findby-mapping-dropdown').append(textToInsert);
	    ...
	    tagCloudStyle: (function(searchCountValue){
	    	...
	    	if (searchCount < 1){
	    		...
	    		style += 'style="font-size:2em;"';
	    	}
	    	else if (searchCount < 100){
	    		
	    		style += 'style="font-size:2.3em;"';
	    	}
	    	else {
	    		
	    		style += 'style="font-size:2.6em;"';
	    	}
...
//	    	MyShowcaseArtefact.renderPagination();
	    ...
	    loadArtefactList: (function(tagValue,typeValue,orderValue,searchTerm,competencyId,mappingId){
			...
			var sakai = 'Sakai';
		   	...
		   	alert("loadArtefactList ownerId = " + ownerId);
