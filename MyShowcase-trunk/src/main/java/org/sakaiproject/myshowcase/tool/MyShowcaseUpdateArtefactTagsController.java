...
public class MyShowcaseUpdateArtefactTagsController extends AbstractController{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		if (action.equals("add")){
			...
			myshowcaseService.addArtefactTag(artefactId, tagName);
			
		}
		else if (action.equals("delete")){
			
			myshowcaseService.removeTagFromArtefact(artefactId, tagName);
		}
