...
<head>
	...
	<script src="<c:url value="/javascript/CollectEvidenceRss.js"/>" language="JavaScript" type="text/javascript"></script> 	
...
<body>
	<p id="box-title">collect an RSS feed</p>
	<form class="ms-inputform-link" id="DataEntry" id="DataEntry" method="post">
		<div class="ms-formrow" id="ms-formrow-rss">
			<label for="input1">Enter the url of the rss feed you'd like to collect into your evidence stream:</label>  
		...
		<div class="ms-formrow" id="ms-formrow-name">
			<label for="input2">Add a reference name for your rss feed. This will appear against these items in your evidence feed:</label>  
			<div class="form-line-clear"></div>
			<input id="input2" type="text" value="" />
		</div>
		<div class="ms-formrow">
			<label for="input4">Add a reference description for your rss feed. This will appear against this item in your evidence stream:</label> 
			<div class="form-line-clear"></div> 
			<textarea id="input4" type="text" rows="4" cols="51" value="" ></textarea>
		</div>
		...
		<div><input id="type" type="hidden" name="type" value="Rss"/>
	...
	<form id="collectionOutcome" name="collectionOutcome" action="collectionOutcome.htm" method="post"> 
		<div>
			<input type="hidden" name="collectionLink" id="collectionLink" value="rss.htm?ownerId=${owner.ownerId}"></input>	
