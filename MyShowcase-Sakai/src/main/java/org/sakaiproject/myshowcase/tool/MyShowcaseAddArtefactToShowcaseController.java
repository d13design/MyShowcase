...
public class MyShowcaseAddArtefactToShowcaseController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
        ...
        myshowcaseService.addArtefactToShowcase(artefact,showcase);
        
        showcase = myshowcaseService.obtainCurrentShowcase(owner);
