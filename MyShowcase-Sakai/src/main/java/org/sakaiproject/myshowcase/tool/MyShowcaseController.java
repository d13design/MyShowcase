...
public class MyShowcaseController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
        ...
        //Add view
        ModelAndView mav = new ModelAndView("MyShowcase");
        //Add model
//        Owner owner =  myshowcaseService.obtainOwner(sessionService.getCurrentUserId());
